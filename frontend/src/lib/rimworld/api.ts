// Typed wrappers over the generated Wails bindings for the RimWorld service —
// the only place the RimWorld module calls its backend. Command names and
// shapes are bound by docs/ARCHITECTURE.md; the bindings themselves come from
...
import * as App from '$bindings/muster/internal/rimworld/service';
import type {
  ActiveModList,
  DetectedPaths,
  ModInfo,
