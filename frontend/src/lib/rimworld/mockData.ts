...
const PROFILES: Profile[] = [
  {
    id: 'medieval-run',
    name: 'Medieval Run',
    path: '/home/you/.local/share/muster/rimworld/profiles/medieval-run',
  ...
  },
  {
    id: 'vanilla-plus',
    name: 'Vanilla Plus',
    path: '/home/you/.local/share/muster/rimworld/profiles/vanilla-plus',
  ...
  },
  {
    ...
    path: '/home/you/.local/share/muster/rimworld/profiles/modding-sandbox',
...
function add(name: string, saveCount: number, activeIds: string[]): Profile {
  ...
  const p: Profile = {
    id,
    name,
    path: `/home/you/.local/share/muster/rimworld/profiles/${id}`,
...
export const mockApi = {
  ...
  detectPaths: () =>
    delay<DetectedPaths>({
      ...
      profilesDir: '/home/you/.local/share/muster/rimworld/profiles'
    }),
