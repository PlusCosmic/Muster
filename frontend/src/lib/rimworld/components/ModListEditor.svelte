<script lang="ts">
  import { app, CORE_ID } from '$lib/rimworld/stores/app.svelte';
  import type { ModInfo, ModSource } from '$lib/rimworld/types';
  import Icon from '$lib/shell/components/Icon.svelte';
  import ModRow from '$lib/rimworld/components/ModRow.svelte';
  import WarningsPanel from '$lib/rimworld/components/WarningsPanel.svelte';
