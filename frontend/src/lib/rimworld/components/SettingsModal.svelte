...
<Modal title="Settings" subtitle="Path overrides and mod-sorting data" width={620} onclose={cancel}>
  ...
  <section class="group">
    <h3>Paths</h3>
    <p class="group-note">
      Leave a field empty to use the detected location. Overrides are stored in Muster’s
  ...
  <section class="group">
    ...
    <p class="group-note">
      RimSort’s community load-order rules make auto-sort much better. Muster caches it locally
