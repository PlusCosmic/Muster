// DEV-ONLY fixture backend so the UI can be developed without a Rust build.
...
export const mockApi = {
  ...
  createShortcut: (id: string) =>
    delay(`/home/you/.local/share/applications/rimforge-${id}.desktop`),
